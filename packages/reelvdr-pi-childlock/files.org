...
etc/vdr/plugins/pin/channellocks.conf
vdr-plugins/src/pin/fskcheck    usr/sbin/fskcheck       exe
vdr-plugins/lib/libvdr-pin.so.2.1.6	usr/lib/vdr/libvdr-pin.so.2.1.6	      lib     -
