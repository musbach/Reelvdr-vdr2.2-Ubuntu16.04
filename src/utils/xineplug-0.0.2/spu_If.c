...
void SpuCopyEvent(reel_video_overlay_event_t *newEvent, reel_video_overlay_event_t *event)
{
...
void SpuCopyOverlayObject(reel_video_overlay_object_t *newObject, reel_video_overlay_object_t *object)
{
...
void SpuCopyOverlay(reel_vo_overlay_t *newOverlay, reel_vo_overlay_t *overlay)
{
...
void SpuCopyButtons(reel_vo_buttons_t *newButton, reel_vo_buttons_t *button)
{ 
