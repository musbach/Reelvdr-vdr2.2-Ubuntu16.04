...
//plugin_info_t const xine_plugin_info[] __attribute__ ((EXPORTED)) =
//plugin_info_t const xine_plugin_info[] __attribute__ ((dllexport)) =
extern plugin_info_t const xine_plugin_info[] =
{
