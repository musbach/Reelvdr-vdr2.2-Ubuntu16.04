...
#ifdef REELVDR
  else if ((Level != OSD_LEVEL_DEFAULT && cOsd::IsOpen()))
     return new cOsd(Left, Top, 999); // create a dummy cOsd (subtitle on open osd), so that access won't result in a segfault
#endif
  else if (osdProvider) {
