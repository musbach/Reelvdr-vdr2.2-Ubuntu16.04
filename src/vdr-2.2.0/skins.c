...
void cSkinDisplayMenu::SetTabs(int Tab1, int Tab2, int Tab3, int Tab4, int Tab5)
{
  ...
  tabs[0] = 0;
  tabs[1] = Tab1 ? (tabs[0] + ((Tab1>0) ? (Tab1*AvgCharWidth) : -Tab1)) : 0;
  tabs[2] = Tab2 ? (tabs[1] + ((Tab2>0) ? (Tab2*AvgCharWidth) : -Tab2)) : 0;
  tabs[3] = Tab3 ? (tabs[2] + ((Tab3>0) ? (Tab3*AvgCharWidth) : -Tab3)) : 0;
  tabs[4] = Tab4 ? (tabs[3] + ((Tab4>0) ? (Tab4*AvgCharWidth) : -Tab4)) : 0;
  tabs[5] = Tab5 ? (tabs[4] + ((Tab5>0) ? (Tab5*AvgCharWidth) : -Tab5)) : 0;
...
#ifdef REELVDR
void cSkinDisplayMenu::EnableSideNote(bool) {}
void cSkinDisplayMenu::SideNote(const cRecording *Rec) {}
void cSkinDisplayMenu::SideNote(const cEvent *Event, const cStringList* sl) {}
void cSkinDisplayMenu::SideNote(const cChannel*) {}
void cSkinDisplayMenu::SideNote(const cStringList *StrList) {}
void cSkinDisplayMenu::SideNoteIcons(const char*) {}
void cSkinDisplayMenu::ClearSideNote() {}
#endif
...
#ifdef REELVDR
void cSkinDisplayReplay::SetHelp(const char*r, const char* g, const char *y, const char *b)
{
}
#endif
// --- cSkin -----------------------------------------------------------------
...
#ifdef REELVDR
eKeys cSkins::ProcessQueuedMessages(void)
#else 
