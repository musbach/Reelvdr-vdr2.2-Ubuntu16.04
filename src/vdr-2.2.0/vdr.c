...
//  bool netcvUpdateCalled = false;
  ...
  int c;
#ifdef REELVDR
  while ((c = getopt_long(argc, argv, "a:b:B:c:dD:e:E:g:hk:i:Kl:L:mp:P:r:s:t:Tu:v:Vw:", long_options, NULL)) != -1) {
#else
...
//#ifdef REELVDR // from reel vdr-1.4
  ...
  if (icountnetcv<10){
    ...
    esyslog("netcv -> else end of netcv %d";icountnetcv);
  }
 } // active mode
             ...
             case kPlay:
                  if (cReplayControl::LastReplayed()) {
                     ...
                     if (cStatus::MsgReplayProtected(0, cReplayControl::LastReplayed(), 0, false) == false) {
                         ...
                         cReplayControl::SetRecording(cReplayControl::LastReplayed()
