...
#ifdef REELVDR
  bool DeviceNeedDelayedTrickmode() { return device ? device->NeedDelayedTrickmode() : false; }
  bool DeviceNeedTrickSpeedDir() { return device ? device->NeedTrickSpeedDir() : false; }
  void DeviceOverflowDetected() { if(device) device->OverflowDetected(); }
#endif /*REELVDR*/
  void Detach(void);
...
#ifdef REELVDR
  virtual bool CanHandleMenuCalls() {return false;}
  virtual bool PlayerIsInMenuDomain() {return false;}
#endif
  };
