...
//                    fprintf(stderr, "vdr-satellit: option: %i %s\n", c, optarg);
                    break;
#ifdef USE_LIVEBUFFER
...
//                    fprintf(stderr, "vdr-satellit: option: %i %s\n", c, optarg);
                    break;
          case 'c' | 0x100: 
//                    fprintf(stderr, "vdr-satellit: I don't know what to do with this option: %s\n", optarg);
                    return 2;
                    break;
...
/*#ifdef REELVDR*/
		   ...
		   DaemonMode = true; break;
#else
	 	   {
                    ...
                    break;
          case 'e' | 0x100:
                    fprintf(stderr, "vdr-satellit: option: %s\n", optarg);
