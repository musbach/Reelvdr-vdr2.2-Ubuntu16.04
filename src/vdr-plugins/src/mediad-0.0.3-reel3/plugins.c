...
//        VideoDirectory = _st_tmpCdrom;
        bool result = cVideoDirectory::RenameVideoFile(cVideoDirectory::Name(), _st_tmpCdrom);
    } //else
    //  VideoDirectory = _st_curDirectory;

// satellit hack
//    DDD("open recmenu in %s", VideoDirectory);
    DDD("open recmenu in %s", cVideoDirectory::Name());
...
//        VideoDirectory = oldvideodir; // remove this if necessary
        bool result = cVideoDirectory::RenameVideoFile(cVideoDirectory::Name(), oldvideodir);
        p->Service("archive", (void *) "mount"); // call services
        osd = p->MainMenuAction();
...
// satellit hack
//    VideoDirectory = oldvideodir;
    result = cVideoDirectory::RenameVideoFile(cVideoDirectory::Name(), oldvideodir);
    _st_status->LinkedRecording(true);
