...
struct Epgsearch_exttimers_v1_0
{
// in
// out
    cOsdMenu* pTimersMenu;   // pointer to the menu of results
};

// Data structure for service "Epgsearch-searchmenu-v1.1"
struct Epgsearch_searchmenu_v1_1
{
// in
// out
    cOsdMenu* pSearchMenu;   // pointer to the search menu
    const char *text;        // text for new searchtimer
};
