...
//#if REELVDR
// wrong:  menu->Add(new cMenuEditStrItem(tr(title),value,size,allowed,"Softcam"));
// wrong:  menu->Add(new cMenuEditStrItem("Softcam"));
// wrong:  menu->Add(new cMenuEditStrItem(tr(title)));
//  menu->Add(new cMenuEditStrItem(tr(title),"Softcam",sizeof("Softcam")));
//  menu->Add(new cMenuEditStrItem(tr(title),value,sizeof(value),allowed));
}
