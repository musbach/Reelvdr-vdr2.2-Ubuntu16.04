...
#define CHECK_CONCURRENCY ((void)0)
    ...
    void ReelBoxDevice::Restart()
    {
        ...
        //bkgPicPlayer_ = *this;
        //Clear();
        printf ("[reelbox] \033[0;44m  Restart \033[0m\n");
        SetPlayModeOff();
...
//        return (stc == 0) ? -1LL : stc;
    ...
    bool ReelBoxDevice::SetPlayMode(ePlayMode playMode)
    {
        ...
        try
        {
            ...
            {
                printf ("[reelbox] \033[0;44m  SetPlayMode \033[0m\n");
                SetPlayModeOff();
            }
#if VDRVERSNUM >= 10716
...
/*            if (audioPlayerHd_)
    ...
    void ReelBoxDevice::SetPlayModeOff()
    {
        ...
        {
            audioPlayerHd_->Stop();
            printf ("[reelbox] \033[0;44m  after audioPlayerHd_->Stop \033[0m\n");
        }
        if (audioPlayerBsp_)
        {
            audioPlayerBsp_->Stop();
            printf ("[reelbox] \033[0;44m  after audioPlayerBsp_->Stop \033[0m\n");
        }

        videoPlayer_->Stop();
        printf ("[reelbox] \033[0;44m  after videoPlayer_->Stop \033[0m\n");
        printf ("[reelbox] \033[0;44m  return \033[0m\n");
    }
