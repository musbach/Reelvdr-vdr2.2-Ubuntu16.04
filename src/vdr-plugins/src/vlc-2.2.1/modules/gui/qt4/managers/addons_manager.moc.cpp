...
static const char qt_meta_stringdata_AddonsManager[] = {
    "AddonsManager\0\0addonAdded(addon_entry_t*)\0"
    "addonChanged(const addon_entry_t*)\0"
    "discoveryEnded()\0findNewAddons()\0uri\0"
    "findDesignatedAddon(QString)\0"
    "findInstalled()\0"
};
...
const QMetaObjectExtraData AddonsManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject AddonsManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AddonsManager,
      qt_meta_data_AddonsManager, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AddonsManager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddonsManager))
