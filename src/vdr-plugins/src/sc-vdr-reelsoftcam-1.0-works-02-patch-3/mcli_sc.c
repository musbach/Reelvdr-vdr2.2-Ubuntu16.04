...
//		return (cam && slots[Slot]) ? slots[Slot]->Status():msNone; 
		return (cam && cCiAdapter.slots[Slot]) ? cCiAdapter.slots[Slot]->eModuleStatus.Status():msNone; 
...
//	cam=new cCam(this,CardIndex());
	cam=new cCam((cScDvbDevice*)this,CardIndex());
#ifdef USE_OE
