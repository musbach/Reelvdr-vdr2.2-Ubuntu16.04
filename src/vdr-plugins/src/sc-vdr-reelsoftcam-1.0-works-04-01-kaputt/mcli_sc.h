...
//	virtual bool SoftCSA(bool live) { return true; }
	virtual bool SoftCSA(bool live);
/*#if APIVERSNUM < 10500
...
//	cDeCsaTSBuffer *tsBuffer; // to be defined?
	cMutex dataMutex;
//	cTimeMs wait;
	cTimeMs wait, lastDump;
	bool delivered;
	bool scActive;
#ifdef HW_MINI
	static int  rbm_fd;
	rbm_dmx_pids   dmx_pids;
#endif
	bool gotcw;
	bool thread_run;
	bool thread_running;
