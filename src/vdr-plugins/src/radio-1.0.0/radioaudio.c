...
void cRTplusOsd::Load(void) 
{
    ...
    switch (bcount) {
        case 4:     if (helpmode == 0)
                        SetHelp(btext[0], btext[1], btext[2], ">>",NULL);
                    else if (helpmode == 1)
                        SetHelp("<<", btext[3], NULL, tr("Exit"),NULL);
                    break;
        case 5:     if (helpmode == 0)
                        SetHelp(btext[0], btext[1], btext[2], ">>",NULL);
                    else if (helpmode == 1)
                        SetHelp("<<", btext[3], btext[4], tr("Exit"),NULL);
                    break;      
        case 6:     if (helpmode == 0)
                        SetHelp(btext[0], btext[1], btext[2], ">>",NULL);
                    else if (helpmode == 1)
                        SetHelp("<<", btext[3], btext[4], ">>",NULL);
                    else if (helpmode == 2)
                        SetHelp("<<", btext[5], NULL, tr("Exit"),NULL);
                    break;
        case 7:     if (helpmode == 0)
                        ...
                        SetHelp("<<", btext[5], btext[6], tr("Exit"),NULL);
                    break;
        default:    helpmode = 0;
                    SetHelp(btext[0], btext[1], btext[2], tr("Exit"),NULL);
        }
}
...
void cRTplusList::Load(void) 
{
    ...
    SetHelp(NULL, NULL , refresh ? tr("Refresh Off") :  tr("Refresh On"), tr("Back"),NULL);
}
