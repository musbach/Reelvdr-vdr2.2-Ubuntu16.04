...
*/
    ...
    //Add(new cMenuEditStraItem(trVDR("Setup.OSD$Language"),               &data.OSDLanguage, I18nNumLanguages, I18nLanguages()));
    //Add(new cMenuEditIntItem( trVDR("Setup.EPG$Preferred languages"),    &numLanguages, 1, I18nNumLanguages));
    //for (int i = 1; i < numLanguages; i++) {
    //Add(new cMenuEditStraItem(trVDR(" Setup.EPG$Preferred language"),     &data.EPGLanguages[i], I18nNumLanguages, I18nLanguages()));
    // }
...
void cMenuSetupEPG::Setup(void)
{
    ...
    /*
       ...
       Add(new cMenuEditIntItem( trVDR("Setup.EPG$Preferred languages"),       &numLanguages, 0, I18nNumLanguages));
