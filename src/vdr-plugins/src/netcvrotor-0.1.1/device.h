...
///HACK satellit virtual bool IsTunedToTransponder (const cChannel * Channel) const;
	bool IsTunedToTransponder (const cChannel * Channel) const;
	bool IsTunedToTransponder (cChannel * Channel);
