...
//    SetHelp(hasEvent?tr("Button$Repeats"):NULL, tr("Button$On/Off"), hasTimer?tr("Button$Delete"):NULL, tr("Button$Commands"));
    SetHelp(trVDR("Button$On/Off"), trVDR("Button$Delete"), hasEvent ? tr("Button$Repeats"):NULL, tr("Button$Functions"));
}
