...
inline std::string prettyPrint< std::set<ept::debtags::Debtags> >( const std::set<ept::debtags::Debtags> &s )
{
    std::string res;
//    for (std::set<ept::debtags::Tag>::const_iterator i = s.begin();
    for (std::set<ept::debtags::Debtags>::const_iterator i = s.begin();
         i != s.end(); i++)
        if (i == s.begin())
//            res += i->fullname();
            res += i->pathname();
...
template< typename M = ept::debtags::Debtags >
struct TagMatch : Match< std::set<ept::debtags::Debtags>, TagMatch< M > >
{
protected:
	M m_tag;
public:
...
//	bool operator()( const std::set<ept::debtags::Tag>& tags )
	bool operator()( const std::set<ept::debtags::Debtags>& tags )
	{
...
typedef TagMatch< ept::debtags::Debtags > Tag;
typedef TagMatch< std::set<ept::debtags::Debtags> > TagSet;
...
//	typedef std::set<ept::debtags::Tag> argument_type;
	typedef std::set<ept::debtags::Debtags> argument_type;
